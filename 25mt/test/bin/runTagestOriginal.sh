...
printf "Running autodiff tagest in \""`pwd`"\"... \n"
...
if [ ! -f ../../../../../rtagest25 ]; then
printf "Checking autodiff tagest in \""`pwd`"\"... "
printf "FAILED\n"
printf "Error: missing ../../../../../rtagest25\n"
exit 0
fi
../../../../../rtagest25 &> tagestOriginal.log
