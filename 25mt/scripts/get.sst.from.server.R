...
get.sst.from.server<-function(lonlow, lonhigh, latlow, lathigh, datelow, datehigh, folder='sst',
...
# An example
path<-get.sst.from.server(150,180,0,30,c(2003,1,13),c(2004,2,17))  
cat(path, '\n')
cat(dir(path), '\n')
