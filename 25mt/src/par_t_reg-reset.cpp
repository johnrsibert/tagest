//$Id: par_t_reg-reset.cpp 2920 2012-01-18 02:51:43Z eunjung $
#include "par_t_reg.h"
#include "trace.h"
...
const dvar_vector& slope , const dvar_vector& inflection , const dvariable &sus_spd)
{
...
reset(const dvar_vector &q, const dvariable &mort, const dvariable &special_mort, const dvar_vector &report_rates,
      ...
      const dvar_vector& slope, const dvar_vector& inflection, const dvariable &sus_spd) {HERE}
