//$Id: par_t_reg.h 2985 2012-07-12 01:22:24Z jsibert $
  ...
  public par_t < D3_ARRAY, MATRIX, VECTOR, DOUBLE >
{
 public:
   ...
   using par_t < D3_ARRAY, MATRIX, VECTOR, DOUBLE >::slope;
   ...
   using par_t < D3_ARRAY, MATRIX, VECTOR, DOUBLE >::set_slope;
 ...
 public:
   ...
   void uvcomp(MATRIX & u, MATRIX & v, const int season);
