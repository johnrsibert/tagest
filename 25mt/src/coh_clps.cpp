...
void par_t<D3_ARRAY,MATRIX,VECTOR,DOUBLE>::collapse_cohorts(recaptype_vector& recaps, const int nrec)
{
...
template void par_t<d3_array,dmatrix,dvector,double>::collapse_cohorts(recaptype_vector& recaps, const int nrec);
template void par_t<dvar3_array,dvar_matrix,dvar_vector,dvariable>::collapse_cohorts(recaptype_vector& recaps, const int nrec);
