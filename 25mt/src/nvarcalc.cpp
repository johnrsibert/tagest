//$Id: nvarcalc.cpp 2754 2011-01-02 20:57:07Z jsibert $
#include "par_t_reg.h"
...
int par_t_reg<D3_ARRAY,MATRIX,VECTOR,DOUBLE>::nvarcalc()
{
  int     ii, s, k;
  ii = 0;
  if (m_ipar[24] > 0)
...
template int par_t_reg<d3_array,dmatrix,dvector,double>::nvarcalc();
template int par_t_reg<dvar3_array,dvar_matrix,dvar_vector,dvariable>::nvarcalc();
