//$Id: iparname.cpp 2983 2012-07-05 23:41:11Z jsibert $
#include "ipar.h"
...
void set_ipar_names(ipar_t& t)
{
  ...
  t.set_name(13, "tag cohort pooling; 0 => no pooling; 1=> pooling; 2 => pooling by date");
    t[13] = 1;
  t.set_name(14, "0 => omit n months from release from likelihood; deprecated");
...
//    t[26] = 0;
  ...
  t.set_name(85, "FAD-D factor model code; 0=>no effect; 1=>effect by sigma computation");
  t.set_name(86, "FAD-uv factor model code-using sus_spd; -1=>no effect;1=>effect by uv computation");
  //t.set_name(87, "FAD-uv factor model code-using mean_size; -1=>no effect;1=>effect by uv computation");
  t.set_name(88, "FAD-D factor model code-using slope; -1=>no effect;1=>effect by sigma computation");
  t.set_name(89, "FAD-D factor model code-using inflection; -1=>no effect;1=>effect by sigma computation");
  //t.set_name(90, "");
