...
#include "policy.h"
#include "recap_t.h"
//#if !defined(JNI_H) && !defined(_JAVASOFT_JNI_H_)
//  class JNIEnv;
//  class jobject;
//#endif
typedef struct /* holds parameters specific to a region */
{
  double u;     // ew component positive to the east; Nmi per day
  double v;     // ns component positive to the north; Nmi per day
  double sigma; // dipsersion; Nmi^2 per month
} gridpartype_;
...
private://Variables
  ...
  //static adstring par_file_version;
