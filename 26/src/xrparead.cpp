//$Id: xrparead.cpp 2987 2012-07-27 23:19:07Z eunjung $
#include "par_t_reg.h"
#include "bound.h"
#include "trace.h"
...
par_t_reg::par_t_reg(doc)::par_t_reg(const ADMB_XMLDoc& doc):par_t(doc)
...
cout << "fullname: " << fullname << endl;
 ...
 par_t_reg::par_t_reg(const ADMB_XMLDoc& doc);
 par_t_reg::par_t_reg(const ADMB_XMLDoc& doc);
