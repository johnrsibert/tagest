//$Id: recap_t.h 3066 2013-04-03 19:54:07Z jsibert $
...
public:
  ...
  Contains zero if fleet is not included in the par_t structure. */
  int   ifr_flindex;
...
class recaptype_vector
{
  ...
  public:
    ...
    static recaptype_vector* createInstance(const adstring &filename, par_t &param, indexed_regional_fishery_record& irfr);
  ...
  public: 
    ...
    ivector count_effortless_recaps(void);
    void tabulate_effortless_recaps(ofstream& os, const adstring_array& fleet_list);
    //                              const int first_year, const int last_year);
