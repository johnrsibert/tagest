//$Id: rparead.cpp 3129 2014-02-03 22:10:56Z eunjung $
#include "par_t_reg.h"
#include "bound.h"
#include "trace.h"
...
par_t_reg::par_t_reg(const char* name): par_t(name,"#v20r")
{
  adstring fullname;
 ...
 par_t_reg::par_t_reg(const char* name);
 par_t_reg::par_t_reg(const char* name);
