//$Id: fish_rec.h 3066 2013-04-03 19:54:07Z jsibert $
/** \file
Class definitions for various fishery record classes.
*/
...
#include "list2.cpp"
#include "shift.h"
#include "fishery_record_vectors.h"
...
class regional_fishery_record /// Details of fishing event expressed in model domain
{
  ...
  public:
    static void set_sw_corner(par_t* _param);
...
class indexed_regional_fishery_record /// Details of fishing events stored for rapid retrieval.
{
  private:
    ...
    i3_array nrec;  ///< Number of records following. 
    regional_fishery_record_vector fishery_records;
...
public:
 ...
 // ~indexed_regional_fishery_record(void);
   ...
   int set_effort_to_recaps(adstring& fleet, recaptype_vector& recaps, 
                            int recap_recs, par_t& ma);
