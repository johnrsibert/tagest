...
void par_t_reg::uvinterpolate(dvar_matrix & uSeasonGrid,
			      dvar_matrix & vSeasonGrid, dvar_matrix & u,
			      dvar_matrix & v, const int season)
{
   ...
   {
      cerr <<
	 "The number of points in the moving average interpolation must be odd."
	 << endl;
