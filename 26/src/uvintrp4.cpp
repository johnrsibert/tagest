//$Id: uvintrp4.cpp 3100 2013-08-17 01:52:57Z jsibert $
#include "par_t_reg.h"
#include "bound.h"
...
void par_t_reg::uvinterpolate(dvar_matrix& u, dvar_matrix& v, year_month& ym)
{

  int season = get_season(ym);
  //int month = get_month(ym);
  
  int t=ym-start_date+1;
  //cout << "t(uvintrp): " << t << endl;
