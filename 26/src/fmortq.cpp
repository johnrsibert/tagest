...
void par_t::fish_mort_comp(dvar3_array& f_mort, const d3_array& effort, year_month& date)
{
  // q dvector
...
void par_t::fish_mort_comp(dvar3_array& f_mort1, dvar3_array& f_mort0, const d3_array& effort, year_month& date, const dvar_matrix& tag_density, const d3_array& recaps0, const dvector& mean_effort)
{
...
void par_t::df_fish_mort_comp(par_t& dfparam, d3_array& dff_mort, d3_array& effort, year_month& dfdate)
{
  if (num_afm)
  {
    year_month afm_date;
