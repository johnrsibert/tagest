...
void par_t<D3_ARRAY,MATRIX,VECTOR,DOUBLE>::pred_recapture_comp(MATRIX& pred_recaptures, const MATRIX& pred_tags, const MATRIX& z, const D3_ARRAY& fmort, const int fleet, const year_month& date)
{
  if (m_ipar[27] == 0)
