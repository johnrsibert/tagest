//$Id: nn_uvs_diagnose.cpp 2754 2011-01-02 20:57:07Z jsibert $
#include "par_t_nn.h"
#include "trace.h"
#include <cifstrem.h>
...
void par_t_nn<D3_ARRAY,MATRIX,VECTOR,DOUBLE>::uvs_diagnose(dmatrix& unode, dmatrix& vnode, dmatrix& snode, 
