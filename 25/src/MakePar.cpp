//$Id: MakePar.cpp 3165 2014-05-20 19:43:19Z eunjung $
/** \file MakePar.cpp
...
int main(int argc, char ** argv)
{
  ...
  cout << banner << endl;
  clogf << banner << endl;
  //rpreproc_main('p', "");// original location
  ...
  readrecaps(param, root_filename, recaps, nrec, "", global_ifr);
  //readrecaps(param, root_filename, recaps, nrec, "", ifr); //ej
  ...
  cout << "recaps.count_effortless_recaps:  " << recaps.count_effortless_recaps() << endl;
