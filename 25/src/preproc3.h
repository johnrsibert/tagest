//$Id: preproc3.h 3162 2014-04-26 01:29:31Z jsibert $
//#include <iostream>
//#include <fstream.h>
//#include <iomanip.h>
//#include <stdlib.h>
...
public:
  ...
  virtual void rel_par_work3(adstring& buffer, 
                     ...
                     List<Shift>& ls, 
                     int& valid_rel){};
  virtual  int rec_par_work3(adstring& buffer, 
                            par_t<d3_array,dmatrix,dvector,double>& par_param, 
                       tagreleasetype_& release_record, 
//                       year_month_vector& last_recapture_date,
                       List<Shift>& ls, 
                       recaptype_vector& recaps) {return 0;} 
...
public:
    ...
    int rec_par_work3(adstring& buffer, 
                       par_t<d3_array,dmatrix,dvector,double>& par_param, 
                       tagreleasetype_& release_record, 
                       List<Shift>& ls, 
