//$Id: dfnblike.cpp 2754 2011-01-02 20:57:07Z jsibert $
#include "precomp.h"
#include "trace.h"
...
void df_nb_like(double& dflike, dmatrix& pred_tags, dmatrix& dfpred_tags,
             ...
             recaptype_vector& recaps, int nrec, par_t<double>& param, par_t<double>& dfparam,
             dmatrix& z, dmatrix& dfz,
             ivector& effort_occured, d3_array& fmort, d3_array& dffmort,
             dvector& aa, dvector& dfaa, const int naa)
