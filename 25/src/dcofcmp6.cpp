//$Id: dcofcmp6.cpp 2754 2011-01-02 20:57:07Z jsibert $
#include "coff_t.h"
#include "intersav.h"
#include "coff_t.h"
...
void Upwind_coff_t<D3_ARRAY,MATRIX,VECTOR,DOUBLE>::dfcomp(coff_t<D3_ARRAY,MATRIX,VECTOR,DOUBLE>& coff, par_t<D3_ARRAY,MATRIX,VECTOR,DOUBLE>& param, par_t<d3_array,dmatrix,dvector,double>& dfparam, dmatrix& u, dmatrix& v, dmatrix& sigma, year_month& date, dmatrix& dfu, dmatrix& dfv, dmatrix& dfsigma, intersavetype * savefile)
{
...
template void Upwind_coff_t<d3_array,dmatrix,dvector,double>::dfcomp(coff_t<d3_array,dmatrix,dvector,double>& coff, par_t<d3_array,dmatrix,dvector,double>& param, par_t<d3_array,dmatrix,dvector,double>& dfparam, dmatrix& u, dmatrix& v, dmatrix& sigma, year_month& date, dmatrix& dfu, dmatrix& dfv, dmatrix& dfsigma, intersavetype * savefile);
template<> void Upwind_coff_t<dvar3_array,dvar_matrix,dvar_vector,dvariable>::dfcomp(coff_t<dvar3_array,dvar_matrix,dvar_vector,dvariable>& coff, par_t<dvar3_array,dvar_matrix,dvar_vector,dvariable>& param, par_t<d3_array,dmatrix,dvector,double>& dfparam, dmatrix& u, dmatrix& v, dmatrix& sigma, year_month& date, dmatrix& dfu, dmatrix& dfv, dmatrix& dfsigma, intersavetype * savefile) {}

template <typename D3_ARRAY, typename MATRIX, typename VECTOR, typename DOUBLE>
void Upwind_coff_t<D3_ARRAY,MATRIX,VECTOR,DOUBLE>::dfcomp(coff_t<D3_ARRAY,MATRIX,VECTOR,DOUBLE>& coff, par_t<D3_ARRAY,MATRIX,VECTOR,DOUBLE>& param, dmatrix& u, dmatrix& v, dmatrix& sigma, year_month& date, dmatrix& dfu, dmatrix& dfv, dmatrix& dfsigma, intersavetype * savefile, dmatrix& dcoff, dmatrix& ecoff, dmatrix& fcoff, dmatrix& ybet_c, dmatrix& ygam_c, dmatrix& dfacoff, dmatrix& dfbcoff, dmatrix& dfccoff, dmatrix& dfdcoff, dmatrix& dfecoff, dmatrix& dffcoff, dmatrix& dfybet, dmatrix& dfygam)
{
...
template void Upwind_coff_t<d3_array,dmatrix,dvector,double>::dfcomp(coff_t<d3_array,dmatrix,dvector,double>& coff, par_t<d3_array,dmatrix,dvector,double>& param, dmatrix& u, dmatrix& v, dmatrix& sigma, year_month& date, dmatrix& dfu, dmatrix& dfv, dmatrix& dfsigma, intersavetype * savefile, dmatrix& dcoff, dmatrix& ecoff, dmatrix& fcoff, dmatrix& ybet_c, dmatrix& ygam_c, dmatrix& dfacoff, dmatrix& dfbcoff, dmatrix& dfccoff, dmatrix& dfdcoff, dmatrix& dfecoff, dmatrix& dffcoff, dmatrix& dfybet, dmatrix& dfygam);
template<> void Upwind_coff_t<dvar3_array,dvar_matrix,dvar_vector,dvariable>::dfcomp(coff_t<dvar3_array,dvar_matrix,dvar_vector,dvariable>& coff, par_t<dvar3_array,dvar_matrix,dvar_vector,dvariable>& param, dmatrix& u, dmatrix& v, dmatrix& sigma, year_month& date, dmatrix& dfu, dmatrix& dfv, dmatrix& dfsigma, intersavetype * savefile, dmatrix& dcoff, dmatrix& ecoff, dmatrix& fcoff, dmatrix& ybet_c, dmatrix& ygam_c, dmatrix& dfacoff, dmatrix& dfbcoff, dmatrix& dfccoff, dmatrix& dfdcoff, dmatrix& dfecoff, dmatrix& dffcoff, dmatrix& dfybet, dmatrix& dfygam) {}

template <typename D3_ARRAY, typename MATRIX, typename VECTOR, typename DOUBLE>
void Upwind_coff_t<D3_ARRAY,MATRIX,VECTOR,DOUBLE>::dfctype(double& dfccoff, double& dfup, double& dffsig, double up, int boundary)
{
  switch (boundary)
  {
    case NONE:
...
template <typename D3_ARRAY, typename MATRIX, typename VECTOR, typename DOUBLE>
void Upwind_coff_t<D3_ARRAY,MATRIX,VECTOR,DOUBLE>::dfbtype(double& dfbcoff, double& dfuu, double& dfbsig, double& dffsig, double _uu, int boundary)
{
  switch (boundary)
  {
    case LEFT_OPEN:
...
template <typename D3_ARRAY, typename MATRIX, typename VECTOR, typename DOUBLE>
void Upwind_coff_t<D3_ARRAY,MATRIX,VECTOR,DOUBLE>::dfatype(double& dfacoff, double& dfum, double& dfbsig, double um, int boundary)
{
  switch (boundary)
  {
    case NONE:
