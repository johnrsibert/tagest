//$Id: readcaps.cpp 3203 2014-08-15 03:17:55Z jsibert $
#include "par_t.h"
#include "bound.h"
#include "recap_t.h"
#include "fish_rec.h"
      ...
      else
      {
        if (cohort_released<D3_ARRAY,MATRIX,VECTOR,DOUBLE>(param, recapture_record))
        {
          ...
          //{
            ...
            //if (recaps[k].ifr_flindex == 37)
            //{
            //TTRACE(fleet, recaps[k].ifr_flindex)
            //int tmpf = adstring_utils_index(param.fleet_names,fleet);
            //TTRACE(fleet,tmpf)
            //}
          ...
          for (int n = n1; n <= n2; n++)
          {
            ...
            if ( (ii == recaps[k].i) && (jj == recaps[k].j) )
            {
               ...
               //cout <<"recapsrecaps[k].effort_flag" << recaps[k].effort_flag << endl;
               break;
            }
          }
          /*
        ...
        */
          ...
          //cout <<"island_caps:" << island_caps << endl;
