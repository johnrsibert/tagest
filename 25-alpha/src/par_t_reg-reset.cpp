//$Id: par_t_reg-reset.cpp 3129 2014-02-03 22:10:56Z eunjung $
#include "par_t_reg.h"
#include "trace.h"
...
const dvar_vector& logslope , const dvar_vector& inflection , const dvariable& chi, const dvariable& loggamma)//const dvariable &sus_spd)
{
...
reset(const dvar_vector &q, const dvariable &mort, const dvariable &special_mort, const dvar_vector &report_rates,
      ...
      const dvar_vector& logslope, const dvar_vector& inflection,  const dvariable& chi, const dvariable& loggamma)  {HERE}//const dvariable &sus_spd)  
