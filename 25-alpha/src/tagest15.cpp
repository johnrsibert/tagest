//$Id: tagest15.cpp 2754 2011-01-02 20:57:07Z jsibert $
/*
 * $admblicense$
 */
#include "par_t.h"
...
int tagest15(int argc, char ** argv)
{
  ...
  while (fmc.ireturn >= 0)
  {
    ...
    //clogf << "finished call "<< fmc.ireturn << " to fmin" << endl;
    {
      if (fmc.ireturn > 0)
      {
        ...
        param.fgcomp2(like, x, g, nvar, *recaps, recaps->getTotalRecords(), *coff, *dfcoff, irfr);
/*
