//$Id: iparname.cpp 3208 2014-08-30 06:54:21Z jsibert $
#include "ipar.h"
...
void set_ipar_names(ipar_t& t)
{
  ...
  t.set_name(24, "number of fishing mortality anomalies; deprecated");
    t[24] = 0;
  t.set_name(25, "catchability estimation; 1=> uniform q; 2=> separate q for each fleet");
    t[25] = 2;
...
//    t[26] = 0;
  ...
  t.set_name(53, "Starting index for q vector; 0 => excluded and unknown mortality in f(0); default = 1");
    t[53] = 1;
  t.set_name(54, "Effort exclusion method; 0 => use effort for all F (default); 1 => do not use effort for F(0); 2=> do not use effort at all");
    t[54] = 0;

  t.set_name(55, "catchability (reporting rate) devs active; weight * 1000");
  ...
  t.set_name(91, ">0 => read taging survivorship vector in par file; number of cohorts in vector");
  t.set_name(92, ">0 => tagging survivorship active; weight");
