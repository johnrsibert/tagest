       ...
       indexed_regional_fishery_record& irfr)
{
  ...
  */
  year_month date, local_start_date, save_start_date, final_date;
  ...
  for (int cc = c1; cc <= c2; cc++)
  {
    ...
    TTRACE(final_date,local_start_date)
    ...
    //dfcoff.dfadi(coff, release, dfrelease, isp);
      ...
      TTRACE(coff_comp_called(kmonth),date)
  ...
  time(&time2);
  times(&tms2);
  double elapsed_clock = (double)(clock2-clock1)/CLOCKS_PER_SEC;
  double elapsed_time = difftime(time2,time1);
  clogf << "\n delta utime " << setprecision(2) << (double)(tms2.tms_utime-tms1.tms_utime)/CLOCKS_PER_SEC
        << "\n delta stime " << setprecision(2) << (double)(tms2.tms_stime-tms1.tms_stime)/CLOCKS_PER_SEC
        << "\n delta cutime " << setprecision(2) << (double)(tms2.tms_cutime-tms1.tms_cutime)/CLOCKS_PER_SEC
        << "\n delta cstime " << setprecision(2) << (double)(tms2.tms_cstime-tms1.tms_cstime)/CLOCKS_PER_SEC << endl;
  clogf << "Objective function value = " << setprecision(8) << plike
        << "; elapsed clock() time = " << setprecision(2) << elapsed_clock 
        << " seconds." << endl;
  clogf << "Objective function value = " << setprecision(8) << plike
        << "; elapsed time()  time = " << setprecision(2) << elapsed_time 
        << " seconds." << endl;
}//End of fgcomp
