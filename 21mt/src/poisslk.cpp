...
void getreturns(d3_array& returns, year_month& date, int cohort,                                recaptype_vector& recaps, int nrec);
	     ...
	     ivector& effort_occured, d3_array& fmort)
{
  ...
  //getreturns(obs, date, cohort, recaps, nrec);
